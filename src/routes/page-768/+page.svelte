...
<svelte:head>
  <title>Page 768 — Team Workspace</title>
  <meta name="description" content="Route 768: Team Workspace. Uses bits-ui Avatar, Tabs, Collapsible, Separator, Button with Tailwind CSS v4." />
</svelte:head>
  ...
  <div class="mx-auto max-w-3xl space-y-8">
    ...
    <header class="space-y-1">
      <div class="flex flex-wrap items-center gap-2">
        ...
        <span class="text-xs text-neutral-400">Route 768</span>
      </div>
      <h1 class="text-3xl font-bold tracking-tight text-neutral-900">Team Workspace</h1>
      <p class="text-base text-neutral-600">
        Reproduction route #768 — bits-ui <code class="rounded bg-neutral-100 px-1.5 py-0.5 font-mono text-sm">Avatar, Tabs, Collapsible, Separator, Button</code>
    ...
    <footer class="flex items-center justify-between border-t border-neutral-200 pt-6 text-xs text-neutral-400">
      <span>Page 768 of 1000</span>
      <div class="flex items-center gap-4">
        <a href="/page-767" class="hover:text-neutral-600">← Previous</a>
        <a href="/reproduction" class="hover:text-neutral-600">Index</a>
        <a href="/page-769" class="hover:text-neutral-600">Next →</a>
      </div>
    </footer>
...
<style>
  ...
  .page-page-768__action:hover {
    background-color: #1d4ed8;
  }
  .page-page-768__action:active {
    transform: scale(0.98);
  }
  .page-page-768__action--secondary {
    background-color: #f3f4f6;
    color: #374151;
  }
  .page-page-768__action--secondary:hover {
    background-color: #e5e7eb;
  }
  .page-page-768__divider {
    height: 1px;
    background-color: #e5e7eb;
    margin: 0.5rem 0;
  }
  ...
  .page-page-768__list-item:hover {
    background-color: #f3f4f6;
  }
</style>
